            ...
            <FormProvider {...methods}>
                <form onSubmit={handleSubmit(handleFormSubmit)}>
                    ...
                    <FormSelect
                        ...
                        disabled={isSubmitting}
                        description="Premium themes are available to paid users only"
                        className={styles.formItem}
                    />
                    ...
                    <FormSelect
                        ...
                        disabled={isSubmitting}
                        description="Inactive themes won't appear in selection lists"
                        className={styles.formItem}
                    />
...
export default PortfolioThemeForm;