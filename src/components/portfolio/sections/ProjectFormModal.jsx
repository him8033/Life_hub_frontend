...
const ProjectFormModal = ({ snapshotId, project, onClose, onSuccess }) => {
    ...
    return (
        <SectionModal
            ...
            subtitle={isEdit ? `Update "${project?.project_name}"` : 'Create a new project'}
                    ...
                    {isEdit && (
                        <div className={styles.gallerySection}>
                            <div className={styles.skillsSectionHeader}>
                                <FiCamera /> Project Gallery ({projectImages.length})
                            </div>
                            ...
                            <div className={styles.uploadGalleryRow}>
                                ...
                                <div className={styles.uploadGalleryRight}>
                                    ...
                                    <Button
                                        ...
                                        disabled={!galleryFile || isUploadingImage}
                                        icon={<FiPlus />}
                                    >
                                        Upload
                                    </Button>
