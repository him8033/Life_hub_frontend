...
import { FiGlobe, FiFolder } from 'react-icons/fi';
import styles from '@/styles/portfolio/portfolio/CreatePortfolioChoice.module.css';

export default function CreatePortfolioChoice({ onStartFresh, onUseExisting, onCancel }) {
    return (
        <div className={styles.overlay} onClick={onCancel}>
            <div className={styles.modal} onClick={e => e.stopPropagation()}>
                <div className={styles.modalHeader}>
                    <h2 className={styles.modalTitle}>Create New Portfolio</h2>
                    ...
                    <button className={styles.optionCard} onClick={onStartFresh}>
                        ...
                        <div className={styles.optionContent}>
                            ...
                            <p className={styles.optionDesc}>
                                Create a brand new portfolio with fresh data. Fill in your details step by step.
                            </p>
                        </div>
